          ...
          >
            ...
            `}
              >
                ...
                <span
                  className={`flex size-8 font-black items-center justify-center absolute top-0 rounded-full bg-[#F5F5F5] text-(--color-primary) ring-8 ring-(--color-secondary) ${index === 0 ? "right-0" : "left-0"}`}
                >
                  {index === 0 ? "→" : "←"}
                </span>
              </button>
