...
function Satisfaction() {
  return (
    <section className="container mx-auto mt-10 px-4 py-7 w-[90%] flex flex-col items-center lg:flex-row lg:justify-around rounded-[34px] bg-(--color-primary) max-lg:gap-y-14 lg:shadow-[-15px_15px_0px_0px_#4383C43D] mb-20">
